...
export default class IntermissionRoom extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(
            "toiletCollider",
            "assets/colliders/ToiletCollider.png"
        );
        this.load.image(
            "redBedCollider",
            "assets/colliders/RedBedCollider.png"
        );
        this.load.image(
            "purpBedCollider",
            "assets/colliders/PurpBedCollider.png"
        );
        this.load.image(
            "redBedBotCollider",
    ...
    create() {
        ...
        this.sceneButton = new Furniture(
            this,
            900,
            190,
            "buttonColliderForHideSeek"
    ...
    update(time, delta) {
        ...
        if (this.octoGuy) {
            ...
            if (
                ...
                (x !== this.octoGuy.oldPosition.x ||
                    y !== this.octoGuy.oldPosition.y)
            ) {
                this.moving = true;
    ...
    addOtherPlayers(scene, playerId) {
        const otherPlayer = new OctoGuy(scene, 340, 240, "octoGuy").setScale(
            2.3
        );
